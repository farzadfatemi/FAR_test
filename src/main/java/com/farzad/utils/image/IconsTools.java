...
import static com.farzad.enums.ArchiEnum.Category;
    ...
    public static String getIconSVGCode(ArchiEnum archiEnum, SVGSingleShape svgShape) {
        ...
        switch (archiEnum) {
            case APPLICATION_COLLABORATION:
                return "<svg class=\"iconStyle\" x=\"" + x + "\" y=\"" + y + "\" width=\"" + width + "\" height=\"" + height + "\" "+ StyleTools.getIconStyles(Category.APPLICATION)+" id=\"Layer_1\" data-name=\"Layer 1\" xmlns=\"http://www.w3.org/2000/svg\" viewBox=\"0 0 25 25\"><defs></defs><path class=\"cls-1\" d=\"M12.5,13.37a5.51,5.51,0,0,1,5.5,5.5v1H7v-1a5.51,5.51,0,0,1,5.5-5.5m0-2.5a8,8,0,0,0-8,8v3.52h16V18.87a8,8,0,0,0-8-8Zm-8,11.52v0Z\"/><path class=\"cls-1\" d=\"M12.5,5a2.6,2.6,0,1,1-2.6,2.6A2.6,2.6,0,0,1,12.5,5m0-2.5a5.1,5.1,0,1,0,5.1,5.1,5.1,5.1,0,0,0-5.1-5.1Z\"/></svg>";
            case APPLICATION_COMPONENT:
                return "<svg class=\"iconStyle\" x=\"" + (x-10) + "\" y=\"" + y + "\" width=\"" + width + "\" height=\"" + height + "\" "+ StyleTools.getIconStyles(Category.APPLICATION)+" id=\"Layer_1\" data-name=\"Layer 1\" xmlns=\"http://www.w3.org/2000/svg\" viewBox=\"0 0 25 25\"><defs></defs><path class=\"cls-1\" d=\"M4.76,0V5.33H0v6.08h4.8v2.17H0v6.08h4.8V25H25V0ZM1.82,9.5V7.25h8.52V9.5Zm0,8.25V15.5h8.52v2.24Zm20.57,4.54h-15V19.67h4.83V13.58H7.36V11.41h4.83V5.33H7.36V2.71h15Z\"/></svg>";
            case APPLICATION_FUNCTION:
                return "<svg class=\"iconStyle\" x=\"" + x + "\" y=\"" + y + "\" width=\"" + width + "\" height=\"" + height + "\" "+ StyleTools.getIconStyles(Category.APPLICATION)+" id=\"Layer_1\" data-name=\"Layer 1\" xmlns=\"http://www.w3.org/2000/svg\" viewBox=\"0 0 25 25\"><defs></defs><path class=\"cls-1\" d=\"M12.5,3l10,6.67V20.33l-8.61-5.74-1.39-.92-1.39.92L2.5,20.33V9.67L12.5,3m0-3L0,8.33V25l12.5-8.33L25,25V8.33L12.5,0Z\"/></svg>";
            case APPLICATION_INTERACTION:
                return "<svg class=\"iconStyle\"  x=\"" + x + "\" y=\"" + y + "\" width=\"" + width + "\" height=\"" + height + "\" "+ StyleTools.getIconStyles(Category.APPLICATION)+" id=\"Layer_1\" data-name=\"Layer 1\" xmlns=\"http://www.w3.org/2000/svg\" viewBox=\"0 0 25 25\"><defs></defs><path class=\"cls-1\" d=\"M8.81,5.43V19.57a7.5,7.5,0,0,1,0-14.14m2.5-2.93a10,10,0,0,0,0,20V2.5Z\"/><path class=\"cls-1\" d=\"M16.19,5.43a7.5,7.5,0,0,1,0,14.14V5.43M13.69,2.5v20a10,10,0,0,0,0-20Z\"/></svg>";
            case APPLICATION_INTERFACE:
                return "<svg class=\"iconStyle\" x=\"" + x + "\" y=\"" + y + "\" width=\"" + width + "\" height=\"" + height + "\" "+ StyleTools.getIconStyles(Category.APPLICATION)+" id=\"Layer_1\" data-name=\"Layer 1\" xmlns=\"http://www.w3.org/2000/svg\" viewBox=\"0 0 25 25\"><defs></defs><path class=\"cls-1\" d=\"M17.15,7.15A5.35,5.35,0,1,1,11.8,12.5a5.35,5.35,0,0,1,5.35-5.35m0-2.5A7.85,7.85,0,1,0,25,12.5a7.85,7.85,0,0,0-7.85-7.85Z\"/><rect class=\"cls-1\" y=\"11.25\" width=\"10.5\" height=\"2.5\"/></svg>";
            case APPLICATION_OBJECT:
                return "<svg class=\"iconStyle\" x=\"" + x + "\" y=\"" + y + "\" width=\"" + width + "\" height=\"" + height + "\" "+ StyleTools.getIconStyles(Category.APPLICATION)+" id=\"Layer_1\" data-name=\"Layer 1\" xmlns=\"http://www.w3.org/2000/svg\" viewBox=\"0 0 25 25\"><defs></defs><path class=\"cls-1\" d=\"M22.5,2.5v20H2.5V2.5h20M25,0H0V25H25V0Z\"/><path class=\"cls-1\" d=\"M22.5,2.5V5.83H2.5V2.5h20M25,0H0V8.33H25V0Z\"/></svg>";
            case APPLICATION_SERVICE:
                return "<svg class=\"iconStyle\" x=\"" + x + "\" y=\"" + y + "\" width=\"" + width + "\" height=\"" + height + "\" "+ StyleTools.getIconStyles(Category.APPLICATION)+" id=\"Layer_1\" data-name=\"Layer 1\" xmlns=\"http://www.w3.org/2000/svg\" viewBox=\"0 0 25 25\"><defs></defs><path class=\"cls-1\" d=\"M17.15,7.15a5.35,5.35,0,1,1,0,10.7H7.8a5.35,5.35,0,1,1,0-10.7h9.35m0-2.5H7.8a7.85,7.85,0,1,0,0,15.7h9.35a7.85,7.85,0,1,0,0-15.7Z\"/></svg>";
            case BUSINESS_ACTOR:
                return "<svg class=\"iconStyle\" x=\"" + x + "\" y=\"" + y + "\" width=\"" + width + "\" height=\"" + height + "\" "+ StyleTools.getIconStyles(Category.BUSINESS)+" id=\"Layer_1\" data-name=\"Layer 1\" xmlns=\"http://www.w3.org/2000/svg\" viewBox=\"0 0 25 25\"><defs></defs><path class=\"cls-1\" d=\"M12.5,13.37a5.51,5.51,0,0,1,5.5,5.5v1H7v-1a5.51,5.51,0,0,1,5.5-5.5m0-2.5a8,8,0,0,0-8,8v3.52h16V18.87a8,8,0,0,0-8-8Zm-8,11.52v0Z\"/><path class=\"cls-1\" d=\"M12.5,5a2.6,2.6,0,1,1-2.6,2.6A2.6,2.6,0,0,1,12.5,5m0-2.5a5.1,5.1,0,1,0,5.1,5.1,5.1,5.1,0,0,0-5.1-5.1Z\"/></svg>";
            case BUSINESS_COLLABORATION:
                return "<svg class=\"iconStyle\" x=\"" + x + "\" y=\"" + y + "\" width=\"" + width + "\" height=\"" + height + "\" "+ StyleTools.getIconStyles(Category.BUSINESS)+" id=\"Layer_1\" data-name=\"Layer 1\" xmlns=\"http://www.w3.org/2000/svg\" viewBox=\"0 0 25 25\"><defs></defs><path class=\"cls-1\" d=\"M16.58,6.71a5.79,5.79,0,1,1-5.79,5.79,5.8,5.8,0,0,1,5.79-5.79m0-2.5a8.29,8.29,0,1,0,8.29,8.29,8.29,8.29,0,0,0-8.29-8.29Z\"/><path class=\"cls-1\" d=\"M8.29,6.71A5.79,5.79,0,1,1,2.5,12.5,5.8,5.8,0,0,1,8.29,6.71m0-2.5a8.29,8.29,0,1,0,8.29,8.29A8.29,8.29,0,0,0,8.29,4.21Z\"/></svg>";
            case BUSINESS_EVENT:
                return "<svg class=\"iconStyle\" x=\"" + x + "\" y=\"" + y + "\" width=\"" + width + "\" height=\"" + height + "\" "+ StyleTools.getIconStyles(Category.BUSINESS)+" id=\"Layer_1\" data-name=\"Layer 1\" xmlns=\"http://www.w3.org/2000/svg\" viewBox=\"0 0 25 25\"><defs></defs><path class=\"cls-1\" d=\"M13.33,4.65H6.22A2.5,2.5,0,0,0,4.29,8.6h0a7.8,7.8,0,0,1,1,3.9,7.8,7.8,0,0,1-1,3.9h0a2.5,2.5,0,0,0,1.93,3.95h7.11a7.85,7.85,0,0,0,0-15.7Zm0,13.2h-7A10.29,10.29,0,0,0,7.83,12.5,10.29,10.29,0,0,0,6.33,7.15h7a5.35,5.35,0,0,1,0,10.7Z\"/></svg>";
            ...
            case BUSINESS_LOCATION:
                return "<svg class=\"iconStyle\" x=\"" + x + "\" y=\"" + y + "\" width=\"" + width + "\" height=\"" + height + "\" "+ StyleTools.getIconStyles(Category.BUSINESS)+" id=\"Layer_1\" data-name=\"Layer 1\" xmlns=\"http://www.w3.org/2000/svg\" viewBox=\"0 0 25 25\"><defs></defs><path class=\"cls-1\" d=\"M12.49,2.58a5.3,5.3,0,0,1,5.3,5.3c0,1.27-1.66,5.7-5.29,12.15C9.67,15,7.19,9.66,7.19,7.88a5.3,5.3,0,0,1,5.3-5.3m0-2.48A7.78,7.78,0,0,0,4.72,7.88c0,4.29,7.78,17.06,7.78,17.06s7.78-12.76,7.78-17.06A7.78,7.78,0,0,0,12.49.1Z\"/></svg>";
            case BUSINESS_MEANING:
                return "<svg class=\"iconStyle\" x=\"" + x + "\" y=\"" + y + "\" width=\"" + width + "\" height=\"" + height + "\" "+ StyleTools.getIconStyles(Category.BUSINESS)+" id=\"Layer_1\" data-name=\"Layer 1\" xmlns=\"http://www.w3.org/2000/svg\" viewBox=\"0 0 25 25\"><defs></defs><path class=\"cls-1\" d=\"M16.57,4.77a4.92,4.92,0,0,1,5.17,4.62,4.16,4.16,0,0,1-.21,1.32l-.38,1.13.67,1a4.47,4.47,0,0,1,.79,2.51,5.18,5.18,0,0,1-5.43,4.86H7.83A5.18,5.18,0,0,1,2.4,15.32,4.59,4.59,0,0,1,4,11.88l.71-.63.09-.94A3.43,3.43,0,0,1,9.54,7.47l1.68.7,1.13-1.43a5.38,5.38,0,0,1,4.22-2m0-2.4a7.75,7.75,0,0,0-6.1,2.89,5.83,5.83,0,0,0-8,4.83A7,7,0,0,0,0,15.32a7.57,7.57,0,0,0,7.83,7.27h9.33A7.57,7.57,0,0,0,25,15.32a6.84,6.84,0,0,0-1.2-3.86,6.55,6.55,0,0,0,.34-2.08,7.31,7.31,0,0,0-7.57-7Z\"/></svg>";
            case BUSINESS_OBJECT:
                return "<svg class=\"iconStyle\" x=\"" + x + "\" y=\"" + y + "\" width=\"" + width + "\" height=\"" + height + "\" "+ StyleTools.getIconStyles(Category.BUSINESS)+" id=\"Layer_1\" data-name=\"Layer 1\" xmlns=\"http://www.w3.org/2000/svg\" viewBox=\"0 0 25 25\"><defs></defs><path class=\"cls-1\" d=\"M22.5,2.5v20H2.5V2.5h20M25,0H0V25H25V0Z\"/><path class=\"cls-1\" d=\"M22.5,2.5V5.83H2.5V2.5h20M25,0H0V8.33H25V0Z\"/></svg>";
            case BUSINESS_PROCESS:
                return "<svg class=\"iconStyle\" x=\"" + x + "\" y=\"" + y + "\" width=\"" + width + "\" height=\"" + height + "\" "+ StyleTools.getIconStyles(Category.BUSINESS)+" id=\"Layer_1\" data-name=\"Layer 1\" xmlns=\"http://www.w3.org/2000/svg\" viewBox=\"0 0 25 25\"><defs></defs><path class=\"cls-1\" d=\"M15.05,6l6.44,6.44-6.44,6.44V15.35H2.5V9.65H15.05V6m-2.5-6V7.15H0v10.7H12.55v7.1L25,12.47,12.55,0Z\"/></svg>";
            case BUSINESS_PRODUCT:
                return "<svg class=\"iconStyle\" x=\"" + x + "\" y=\"" + y + "\" width=\"" + width + "\" height=\"" + height + "\" "+ StyleTools.getIconStyles(Category.BUSINESS)+" id=\"Layer_1\" data-name=\"Layer 1\" xmlns=\"http://www.w3.org/2000/svg\" viewBox=\"0 0 25 25\"><defs></defs><path class=\"cls-1\" d=\"M22.5,2.5v20H2.5V2.5h20M25,0H0V25H25V0Z\"/><path class=\"cls-1\" d=\"M9.58,2.5V5.83H2.5V2.5H9.58M12.08,0H0V8.33H12.08V0Z\"/></svg>";
            case BUSINESS_REPRESENTATION:
                return "<svg class=\"iconStyle\" x=\"" + x + "\" y=\"" + y + "\" width=\"" + width + "\" height=\"" + height + "\" "+ StyleTools.getIconStyles(Category.BUSINESS)+" id=\"Layer_1\" data-name=\"Layer 1\" xmlns=\"http://www.w3.org/2000/svg\" viewBox=\"0 0 25 25\"><defs></defs><path class=\"cls-1\" d=\"M22.5,2.5v20H2.5V2.5h20M25,0H0V25H25V0Z\"/><path class=\"cls-1\" d=\"M9.58,2.5V5.83H2.5V2.5H9.58M12.08,0H0V8.33H12.08V0Z\"/></svg>";
//            case BUSINESS_ROLE:
//                return "<svg class=\"iconStyle\" x=\"" + x + "\" y=\"" + y + "\" width=\"" + width + "\" height=\"" + height + "\" "+ getIconStyles(Category.BUSINESS)+" id=\"Layer_1\" data-name=\"Layer 1\" xmlns=\"http://www.w3.org/2000/svg\" viewBox=\"0 0 25 25\"><defs></defs><path class=\"cls-1\" d=\"M22.5,2.5v20H2.5V2.5h20M25,0H0V25H25V0Z\"/><path class=\"cls-1\" d=\"M9.58,2.5V5.83H2.5V2.5H9.58M12.08,0H0V8.33H12.08V0Z\"/></svg>";
            case BUSINESS_SERVICE:
                return "<svg class=\"iconStyle\" x=\"" + x + "\" y=\"" + y + "\" width=\"" + width + "\" height=\"" + height + "\" "+ StyleTools.getIconStyles(Category.BUSINESS)+" id=\"Layer_1\" data-name=\"Layer 1\" xmlns=\"http://www.w3.org/2000/svg\" viewBox=\"0 0 25 25\"><defs></defs><path class=\"cls-1\" d=\"M17.15,7.15a5.35,5.35,0,1,1,0,10.7H7.8a5.35,5.35,0,1,1,0-10.7h9.35m0-2.5H7.8a7.85,7.85,0,1,0,0,15.7h9.35a7.85,7.85,0,1,0,0-15.7Z\"/></svg>";
            case BUSINESS_STAKEHOLDER:
                return "<svg class=\"iconStyle\" x=\"" + x + "\" y=\"" + y + "\" width=\"" + width + "\" height=\"" + height + "\" "+ StyleTools.getIconStyles(Category.BUSINESS)+" id=\"Layer_1\" data-name=\"Layer 1\" xmlns=\"http://www.w3.org/2000/svg\" viewBox=\"0 0 25 25\"><defs></defs><path class=\"cls-1\" d=\"M17.15,4.65H7.8a7.85,7.85,0,1,0,0,15.7h9.35a7.85,7.85,0,0,0,0-15.7Zm-.82,0-.2,0Zm-.8.13-.18,0ZM14.74,5l-.14.05ZM14,5.32l-.09,0Zm-.72.36,0,0Zm-.67.43h0ZM7.8,17.85a5.35,5.35,0,0,1,0-10.7h3.62a7.82,7.82,0,0,0,0,10.7H7.8Zm8.33,2.43.2,0ZM12.6,18.88h0Zm.64.41,0,0Zm.67.34.09,0Zm.7.28.14,0Zm.73.21.18,0Zm1.81-2.28A5.35,5.35,0,1,1,22.5,12.5,5.35,5.35,0,0,1,17.15,17.85Z\"/></svg>";
            case BUSINESS_VALUE:
                return "<svg class=\"iconStyle\" x=\"" + x + "\" y=\"" + y + "\" width=\"" + width + "\" height=\"" + height + "\" "+ StyleTools.getIconStyles(Category.BUSINESS)+" id=\"Layer_1\" data-name=\"Layer 1\" xmlns=\"http://www.w3.org/2000/svg\" viewBox=\"0 0 25 25\"><defs></defs><path class=\"cls-1\" d=\"M12.5,7.1c5.88,0,10,2.85,10,5.4s-4.1,5.4-10,5.4-10-2.85-10-5.4,4.1-5.4,10-5.4m0-2.54C5.61,4.56,0,8.11,0,12.5s5.59,7.94,12.48,7.94S25,16.89,25,12.5,19.39,4.56,12.5,4.56Z\"/></svg>";
            case GOALS_ASSESSMENT:
                return "<svg class=\"iconStyle\" x=\"" + x + "\" y=\"" + y + "\" width=\"" + width + "\" height=\"" + height + "\" "+ StyleTools.getIconStyles(Category.GOALS)+" id=\"Layer_1\" data-name=\"Layer 1\" xmlns=\"http://www.w3.org/2000/svg\" viewBox=\"0 0 25 25\"><defs></defs><path class=\"cls-1\" d=\"M14.64,5a5.35,5.35,0,1,1-3.78,1.57A5.31,5.31,0,0,1,14.64,5m0-2.5a7.85,7.85,0,1,0,5.55,2.3,7.82,7.82,0,0,0-5.55-2.3Z\"/><rect class=\"cls-1\" x=\"0.97\" y=\"17.53\" width=\"10.5\" height=\"2.5\" transform=\"translate(-11.45 9.9) rotate(-45)\"/></svg>";
            case GOALS_CONSTRAINT:
                return "<svg class=\"iconStyle\" x=\"" + x + "\" y=\"" + y + "\" width=\"" + width + "\" height=\"" + height + "\" "+ StyleTools.getIconStyles(Category.GOALS)+" id=\"Layer_1\" data-name=\"Layer 1\" xmlns=\"http://www.w3.org/2000/svg\" viewBox=\"0 0 25 25\"><defs></defs><path class=\"cls-1\" d=\"M22,2.5l-4,20H3l4-20H22M25,0H5L0,25H20L25,0Z\"/><path class=\"cls-1\" d=\"M10.4,2.5l-4,20H3l4-20H10.4m3-2.5H5L0,25H8.45l5-25Z\"/></svg>";
            case GOALS_DRIVER:
                return "<svg class=\"iconStyle\" x=\"" + x + "\" y=\"" + y + "\" width=\"" + width + "\" height=\"" + height + "\" "+ StyleTools.getIconStyles(Category.GOALS)+" id=\"Layer_1\" data-name=\"Layer 1\" xmlns=\"http://www.w3.org/2000/svg\" viewBox=\"0 0 25 25\"><defs></defs><path class=\"cls-1\" d=\"M12.5,5A7.5,7.5,0,1,1,5,12.5,7.51,7.51,0,0,1,12.5,5m0-2.5a10,10,0,1,0,10,10,10,10,0,0,0-10-10Z\"/><rect class=\"cls-1\" x=\"11.25\" width=\"2.5\" height=\"25\"/><rect class=\"cls-1\" y=\"11.25\" width=\"25\" height=\"2.5\"/><rect class=\"cls-1\" y=\"11.25\" width=\"25\" height=\"2.5\" transform=\"translate(-5.18 12.5) rotate(-45)\"/><rect class=\"cls-1\" x=\"11.25\" width=\"2.5\" height=\"25\" transform=\"translate(-5.18 12.5) rotate(-45)\"/></svg>";
            case GOALS_GAP:
            ...
            case INFRASTRUCTURE_INTERFACE:
                return "<svg class=\"iconStyle\" x=\"" + x + "\" y=\"" + y + "\" width=\"" + width + "\" height=\"" + height + "\" "+ StyleTools.getIconStyles(Category.INFRASTRUCTURE)+" id=\"Layer_1\" data-name=\"Layer 1\" xmlns=\"http://www.w3.org/2000/svg\" viewBox=\"0 0 25 25\"><defs></defs><path class=\"cls-1\" d=\"M17.15,7.15A5.35,5.35,0,1,1,11.8,12.5a5.35,5.35,0,0,1,5.35-5.35m0-2.5A7.85,7.85,0,1,0,25,12.5a7.85,7.85,0,0,0-7.85-7.85Z\"/><rect class=\"cls-1\" y=\"11.25\" width=\"10.5\" height=\"2.5\"/></svg>";
